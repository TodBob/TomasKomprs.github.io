//SUPPORTED WITH http://reportcard.rileyh.com/
  ...
  return $.fn.reportCard = function(options) {
    ...
    ReportCard = (function() {
      ...
      ReportCard.prototype.build = function(data) {
        ...
        html = "<h2> " + data.badge_count + " lekcí a získal " + (toThousands(data.points_total)) + " bodů na team " + data.site + "!</h2>\n<p>Podívejte se na některé z mých posledních kurzů s odznaky níže: </p>\n<ul class=\"badges\">";
